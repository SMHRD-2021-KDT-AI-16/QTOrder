        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <script type="text/javascript">
	                /* var totalPrice = ${totalpirce};
	                var menuPrice = ${menuDetail.get(0).getMenu_price()};
	                var totalPriceWithMenu = totalPrice + menuPrice;
	                document.getElementById("submitButton").innerText ="총 "+ totalPriceWithMenu+"원"; */
